        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing modern, responsive, and engaging website interfaces tailored for businesses and content creators.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Editing high-quality videos, creating appealing YouTube thumbnails, and crafting graphic designs for content creators.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
